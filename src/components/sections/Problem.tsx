        ...
        <div className="grid lg:grid-cols-3 gap-16 items-start">
          <div className="lg:col-span-1">
            ...
            <img 
              ...
              alt="Digital rain from The Matrix, representing feeling overwhelmed when moving to a new city."
              className="rounded-lg shadow-xl w-full object-cover h-64 mb-8"
            />
