...
export const WaitlistCTA = () => {
  ...
  return (
    <section className="py-32 px-6 bg-stone-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <Input
              ...
              required
              className="flex-1 bg-white/10 border-white/20 text-white placeholder:text-stone-400 focus:border-white/40"
            />
            <Button
              type="submit"
              disabled={isSubmitting}
              className="bg-white text-stone-800 hover:bg-stone-100 px-8 whitespace-nowrap"
            >
